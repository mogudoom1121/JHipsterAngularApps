package io.github.maksa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("AngularSampleApps");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("AngularSampleApps");
        ...
        config.getMapConfigs().put("io.github.maksa.domain.*", initializeDomainMapConfig(jHipsterProperties));
